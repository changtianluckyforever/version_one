...
class AgentDQN(Agent):
    def __init__(self, movie_dict=None, act_set=None, slot_set=None, params=None):
        ...
        self.dqn = DQN(self.state_dimension, self.hidden_size, self.num_actions, params['duel'], params['double'], params['pav'], params['averaged_dqn'], params['num_target_net'], params['net_parameter'], params['maxmin_dqn'], params['sunrise'], params['batch_size'])
    ...
    def calculate_q_max(self, state, eva=False):
        ...
        if eva:
            act, q_max = self.dqn.predict_new(self.representation, {}, predict_model=True, get_q= True)
            return q_max
        else:
            return None
    ...
    def train(self, batch_size=16,  num_iter=1, discount_factor= 0.1, controller=0, use_real_example=True):
        ...
        for iter in range(num_iter):
            for _ in range(len(running_expereince_pool) / (batch_size)):
                ...
                batch_struct = self.dqn.singleBatch(np_batch, discount_factor)
